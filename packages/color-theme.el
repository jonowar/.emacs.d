...
(defun color-theme-jono ()
  "`color-theme-midnight' with different string and keyword colors.
  midnight was perfect but the magenta and cyan colors are pretty obnoxious"
  (interactive)
  (color-theme-midnight)
  (let ((color-theme-is-cumulative t))
    (color-theme-install
     '(color-theme-jono
       ...
       (font-lock-string-face ((t (:foreground "gray40"))))
       (font-lock-comment-face ((t (:italic t :foreground "chartreuse"))))
